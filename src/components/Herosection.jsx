    ...
    >
      ...
      > 
        ...
        <motion.button 
          ...
          aria-label="Scroll to Contact Ayak Manna"
        >
          SAY HELLO
      ...
      <div className="flex items-center mt-8 md:mt-0">
        ...
        <div className="flex flex-col space-y-4">
          <a href="https://www.facebook.com/ayak.manna.7" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-gray-300 hover:text-green-500 transition hover:scale-110">
            <FaFacebook size={24} />
          </a>
          <a href="https://www.instagram.com/ayak_manna/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-gray-300 hover:text-green-500 transition hover:scale-110">
            <FaInstagram size={24} />
          </a>
          <a href="https://www.linkedin.com/in/ayak-manna/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-gray-300 hover:text-green-500 transition hover:scale-110">
            <FaLinkedin size={24} />
          </a>
          <a href="https://github.com/Ayak-Here" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="text-gray-300 hover:text-green-500 transition hover:scale-110">
            <FaGithub size={24} />
          </a>
        </div>
      </div>
